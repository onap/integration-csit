...
#json files
${service_packages_json}    ${SCRIPTS}/../tests/vfc/nfvo-catalog/jsons/service_packages.json
${ns_packages_json}    ${SCRIPTS}/../tests/vfc/nfvo-catalog/jsons/ns_packages.json
${vnfpackages_catalog_json}    ${SCRIPTS}/../tests/vfc/nfvo-catalog/jsons/vnfpackages_catalog.json
...
Check distribute Service package
    Log    Check distribute Service package
    [Documentation]     check distribute Service package by MSB
    Check distribute package    ${service_packages_json}    ${service_packages_url}
