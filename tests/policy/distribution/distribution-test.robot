...
InvokeDistributionUsingFile And RunEventOnApexEngine
    Move File    ${SCRIPT_DIR}/config/distribution/csar/csar_temp.csar    ${SCRIPT_DIR}/config/distribution/temp/csar_temp.csar
    ...
    Should Be Equal As Strings    ${resp.status_code}   200
    Move File    ${SCRIPT_DIR}/config/distribution/temp/csar_temp.csar    ${SCRIPT_DIR}/config/distribution/csar/csar_temp.csar
