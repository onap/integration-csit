...
InvokeDistributionAndRunEventOnEngine
     Wait Until Keyword Succeeds    5 min    10 sec    InvokeDistributionUsingFile And RunEventOnApexEngine
...
InvokeDistributionUsingFile And RunEventOnApexEngine
    ...
    Sleep    10 seconds    "Waiting for the Policy Distribution to call Policy API and PAP"
