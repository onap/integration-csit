...
Cert Service Client successfully creates keystore and truststore
    ...
    Run Cert Service Client And Validate JKS File Creation With Correct Exit Code  ${VALID_ENV_FILE}  0
...
Run Cert Service Client Container And Validate Exit Code And API Response
    ...
    Run Cert Service Client And Validate Http Response Code With Expected Exit Code  ${INVALID_ENV_FILE}  404  5
