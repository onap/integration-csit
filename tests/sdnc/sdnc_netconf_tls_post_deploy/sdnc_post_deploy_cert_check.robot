...
Test SDNC PNF Mount
    ...
    ${resp}=    Put Request    sdnc    ${SDNC_KEYSTORE_CONFIG_PATH}    data=${mount}    headers=${headers}
    ...
    Should Be Equal As Strings  ${resp1.json()['output']['response-code']}   200
    ${pnfContent}=    Convert To String    ${resp1.content}
    should Contain ${pnfContent}     netconf-id
    should Contain ${pnfContent}     netconf-param
