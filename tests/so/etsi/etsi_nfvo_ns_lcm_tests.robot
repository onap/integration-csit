...
Invoke Instantiate Network Service
    ...
    log to console      \nInstantiate Network Service Response Status Code: ${instantiate_network_service_request.status_code}
    ...
    FOR    ${INDEX}    IN RANGE    ${MAXIMUM_ATTEMPTS_BEFORE_TIMEOUT}
       ...
       log to console      \nNS LCM OP OOCs Response Status Code: ${ns_lcm_status_request.status_code}
...
Invoke Terminate Network Service
    ...
    log to console      \nTerminate Network Service Response Status Code: ${terminate_network_service_request.status_code}
...
Invoke Delete Network Service
    ...
    log to console      \nDelete Network Service Response Status Code: ${delete_network_service_request.status_code}
