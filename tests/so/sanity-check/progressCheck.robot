...
Create ServiceInstance for Dummy Input
    ...
    ${process_id}=  Set Variable    ${resp.json()['requestReferences']['requestId']}
    ...
    #Fill value in textbox and click search and then click matching record
    Input Text    xpath= //*[@id="mat-input-1"]  ${process_id}
    ...
    Should be equal as strings    ${requestIDinUI}  ${process_id}
