...
${AAI_PNF_REGISTARTION_SIMPLE}    %{WORKSPACE}/tests/dcaegen2/prh-testcases/assets/json_events/aai_pnf_registration_simple.json
...
Valid DMaaP event can be converted to PNF_READY notification
    ...
    ${EVENT_PNF_REGISTARTION_SIMPLE}    ${AAI_PNF_REGISTARTION_SIMPLE}
