...
class PrhLibrary(object):
    ...
    def create_invalid_notification(json_file):
        ...
        ipv4 = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "oamV4IpAddress", "oamV4IpAddress")   #PrhLibrary.extract_ip_v4_value(json_to_python, "oamV4IpAddress")
        ipv6 = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "oamV6IpAddress", "oamV6IpAddress") #PrhLibrary.extract_ip_v6_value(json_to_python, "oamV6IpAddress")
        serial_number = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "serialNumber", "serialNumber") #PrhLibrary.extract_serial_number_value(json_to_python, "serialNumber")
        vendor_name = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "vendorName", "vendorName") #PrhLibrary.extract_vendor_name_value(json_to_python, "vendorName")
        model_number = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "modelNumber", "modelNumber") #PrhLibrary.extract_model_number_value(json_to_python, "modelNumber")
        unit_type = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "unitType", "unitType") #PrhLibrary.extract_unit_type_value(json_to_python, "unitType")
    ...
    def create_pnf_ready_notification_as_pnf_ready(json_file):
        json_to_python = json.loads(json_file)
        correlation_id = PrhLibrary.extract_correlation_id_value(json_to_python, "correlationId")
        serial_number = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "serial-number", "serialNumber") #PrhLibrary.extract_serial_number_value(json_to_python, "serial-number")
        vendor_name = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "equip-vendor", "vendorName") #PrhLibrary.extract_vendor_name_value(json_to_python, "equip-vendor")
        model_number = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "equip-model", "modelNumber")#PrhLibrary.extract_model_number_value(json_to_python, "equip-model")
        unit_type = PrhLibrary.extract_value_from_pnfRegistrationFields(json_to_python, "equip-type", "unitType") #PrhLibrary.extract_unit_type_value(json_to_python, "equip-type")
