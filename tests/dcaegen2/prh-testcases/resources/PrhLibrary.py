...
class PrhLibrary(object):
    ...
    def create_invalid_notification(json_file):
        ...
        additional_fields = PrhLibrary.extract_additional_fields_value(json_to_python, '"additionalFields":null')
    ...
    def extract_additional_fields_value(content, alternative_value):
        fields = content.get_additional_fields_as_key_value_pairs(content)
        if len(fields) == 0:
