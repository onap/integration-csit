...
class PrhLibrary(object):
    ...
    def create_pnf_ready_notification_as_pnf_ready(json_file):
        ...
        str_json = '{"correlationId":"' + correlation_id + '","ipaddress-v4-oam":"' + ipv4 + '","ipaddress-v6-oam":"' + ipv6 + '","serial-number":"' + serial_number + '","equip-vendor":"' + vendor_name  + '","equip-model":"' + model_number + '","equip-type":"' + unit_type + '","sw-version":""}'
        python_to_json = json.dumps(str_json)
        return python_to_json.replace("\\", "")[1:-1]
