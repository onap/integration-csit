...
Publish Single VES VNF Measurement Event API V7
    ...
    Send Request And Validate Response  Publish Event To VES Collector No Auth  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  202  ab305d54-85b4-a31b-7db2-fb6b9e546015
...
Publish Single VES VNF Measurement Event with wrong JSON
    ...
    Send Request And Validate Response  Publish Event To VES Collector No Auth  ${VES_EVENTLISTENER_V7}  ${VES_INVALID_JSON_V7}  400
...
Publish Single VES VNF Measurement Event with No Auth over HTTPS
    ...
    Send Request And Expect Error  Publish Event To VES Collector  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  ConnectionError:*  @{err_content}
...
Publish Single VES VNF Measurement Event over HTTP
    ...
    Send Request And Validate Response  Publish Event To VES Collector No Auth  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  400
...
Publish Single VES VNF Measurement Event with certBasicAuth over HTTPS
    ...
    Send Request And Validate Response  Publish Event To VES Collector  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  202  ab305d54-85b4-a31b-7db2-fb6b9e546015
...
Publish Single VES VNF Measurement Event over HTTPS with wrong JSON
    ...
    Send Request And Validate Response  Publish Event To VES Collector  ${VES_EVENTLISTENER_V7}  ${VES_INVALID_JSON_V7}  400
...
Publish Single VES VNF Measurement Event With Wrong Auth
    ...
    Send Request And Validate Response  Publish Event To VES Collector With Wrong Auth   ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  401
...
Publish Single VES VNF Measurement Event With Cert
    ...
    Send Request And Validate Response  Publish Event To VES Collector With Cert  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  202  ab305d54-85b4-a31b-7db2-fb6b9e546015
...
Publish Single VES VNF Measurement Event With Wrong Cert
    ...
    Send Request And Expect Error  Publish Event To VES Collector With Wrong Cert  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  SSLError:*  @{err_content}
...
Publish Single VES VNF Measurement Event With Outdated Cert
    ...
    @{err_content}  Create List  bad handshake  certificate unknown
    Send Request And Expect Error  Publish Event To VES Collector With Outdated Cert  ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  SSLError:*  @{err_content}
...
Publish Single VES VNF Measurement Event Without Auth And Cert
    ...
    Send Request And Validate Response  Publish Event To VES Collector Without Auth And Cert   ${VES_EVENTLISTENER_V7}  ${VES_VALID_JSON_V7}  401
