...
Publish Single VES Event With stndDefinedNamespace = 3GPP-PerformanceAssurance
    ...
    Send Request And Validate Response  Publish Event To VES Collector  ${https_basic_auth_session}  ${VES_EVENTLISTENER_V7}  ${VES_STDN_DEFINED_3GPP_PERFORMANCE_ASSURANCE}  202  unauthenticated.SEC_3GPP_FAULTSUPERVISION_OUTPUT

#Test8
#    [Tags]    DCAE-VESC-R1
#    [Documentation]   Post single event with empty json and expect 400 Response Status Code Test
#    Send Request And Validate Response  Publish Event To VES Collector  ${https_basic_auth_session}  ${VES_EVENTLISTENER_V7}  ${VES_STDN_DEFINED_3GPP_PERFORMANCE_ASSURANCE}  202  stndDefined-gNB-Nokia-PowerLost  /events/unauthenticated.SEC_3GPP_PERFORMANCEASSURANCE_OUTPUT
