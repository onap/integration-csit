...
def validate_cert_contains_sans(cert_chain, expected_sans):
  expected_sans = [_strip_san_type_from_san(str(san)) for san in expected_sans]
...
def _strip_san_type_from_san(san):
  return re.sub(r'.*?:', "", san, 1)
