...
#    Log To Console                  ${dropped_nr}
    ${isCorrectDroppedCount}=       Evaluate  ${6} < ${dropped_nr} < ${9}
#    Log To Console                  "Evaluate: "
#    Log To Console                  ${isCorrectDroppedCount}
    SavePmMapperLogsAndDroppedCount  config_1_1  ${dropped_nr}
    Should Be True                  ${isCorrectDroppedCount}  Pm-mapper drop: ${dropped_nr} messages. Expected drop count: 7-8
    ClearLogs
...
#    Log To Console                  "Dropped:"
#    Log To Console                  ${dropped_nr}
    ${isCorrectDroppedCount}=       Evaluate  ${4} < ${dropped_nr} < ${7}
    SavePmMapperLogsAndDroppedCount  config_4_1  ${dropped_nr}
    Should Be True                  ${5} < ${dropped_nr}  Pm-mapper drop: ${dropped_nr} messages. Expected drop count: 5-7
    ClearLogs
...
#    Log To Console                  ${dropped_nr}
    ...
    Should Be True                  ${dropped_nr} < ${3}  Pm-mapper drop: ${dropped_nr} messages. Expected drop count: 0-2
    ClearLogs
...
#    Log To Console                  ${dropped_nr}
    ...
    Should Be True                  ${dropped_nr} < ${3}  Pm-mapper drop: ${dropped_nr} messages. Expected drop count: 0-3
    ClearLogs
