...
Verify that PM Mapper rejects correct number of messages 1 1
    ...
    Sleep                           40s
    Run Keyword Unless              ${6} < ${dropped_nr} < ${9}     PrintLogAndFail                               ${alllogs}
    ClearLogs
...
Verify that PM Mapper rejects correct number of messages 4 1
    ...
    Sleep                           25s
    Run Keyword Unless              ${5} < ${dropped_nr} < ${7}     PrintLogAndFail                               ${alllogs}
    ClearLogs
...
Verify that PM Mapper rejects correct number of messages 10 1
    ...
    Sleep                           15s
    Run Keyword Unless              ${dropped_nr} < ${3}            PrintLogAndFail                               ${alllogs}
    ClearLogs
