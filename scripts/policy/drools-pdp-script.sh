...
sed -i "s@.*Undo any changes.*@ls -lh /opt/app/policy /opt/app/policy/* /home/policy /tmp/policy-install /tmp/policy-install/config@g" src/main/docker/docker-install.sh
sed -i "s@.*base.conf properties may have.*@ls -lh /opt/app/policy /opt/app/policy/* /home/policy /tmp/policy-install /tmp/policy-install/config@g" src/main/docker/docker-install.sh
