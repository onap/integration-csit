...
sed -i "s@.*base.conf properties may have.*@ls -lh /opt/app/policy /opt/app/policy/* /home/policy /tmp/policy-install /tmp/policy-install/config /opt/app/policy/* /opt/app/policy/*/* @g" src/main/docker/docker-install.sh
sed -i "s@.*check if fqdn.*@ls -lh /opt/app/policy /opt/app/policy/* /home/policy /tmp/policy-install /tmp/policy-install/config /opt/app/policy/* /opt/app/policy/*/* @g" src/main/docker/docker-install.sh
sed -i "s@.*.Note: adding to.*@ls -lh /opt/app/policy /opt/app/policy/* /home/policy /tmp/policy-install /tmp/policy-install/config /opt/app/policy/* /opt/app/policy/*/* @g" src/main/docker/docker-install.sh
sed -i "s@.*crontab*@cat /opt/app/policy/etc/profile.d/*@g" src/main/docker/docker-install.sh
