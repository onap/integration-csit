...
#
echo "This is ${WORKSPACE}/scripts/policy/drools-applications-script.sh"
...
cd ${WORK_DIR}
git clone http://gerrit.onap.org/r/policy/drools-applications
cd drools-applications
${WORK_DIR}/maven/apache-maven-3.3.9/bin/mvn clean install --settings ${WORK_DIR}/oparent/settings.xml
cd ..
chmod +x drools-applications/controlloop/build/docker-cl
drools-applications/controlloop/build/docker-cl --merge
