...
mkdir maven
cd maven
# download maven sources from automatically selected mirror server
curl -LO  "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=maven/maven-3/3.3.9/binaries/apache-maven-3.3.9-bin.tar.gz"
