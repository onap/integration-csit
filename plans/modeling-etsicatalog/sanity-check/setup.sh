...
docker run -d --name modeling-etsicatalog -v /var/lib/mysql -e MSB_ADDR=${DISCOVERY_IP}:10081 -e DB_IP=${DB_IP} -e MSB_ENABLED=false nexus3.onap.org:10001/onap/modeling/etsicatalog
