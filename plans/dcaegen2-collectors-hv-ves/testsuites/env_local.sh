...
export KAFKA_DOCKER_REGISTRY="nexus3.onap.org:10001"
export KAFKA_DOCKER_REGISTRY_PREFIX="${KAFKA_DOCKER_REGISTRY}/"
...
export KAFKA_IMAGE_FULL_NAME="${KAFKA_DOCKER_REGISTRY_PREFIX}onap/dmaap/kafka111:0.0.6"
