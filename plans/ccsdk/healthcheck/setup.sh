...
export CCSDK_DOCKER_IMAGE_VERSION=0.6.1-STAGING-latest
...
docker tag $NEXUS_DOCKER_REPO/onap/ccsdk-odlsli-alpine-image:$CCSDK_DOCKER_IMAGE_VERSION onap/ccsdk-odlsli-alpine-image:0.4-STAGING-latest
