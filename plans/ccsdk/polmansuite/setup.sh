...
cp $WORKSPACE/plans/ccsdk/polmansuite/test_env.sh $WORKSPACE/archives/nonrtric/test/common

# Temporary solution to not test with the SDNC image
cp $WORKSPACE/plans/ccsdk/polmansuite/FTC1.sh $WORKSPACE/archives/nonrtric/test/auto-test/FTC1.sh
