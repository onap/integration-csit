...
TEST_SCRIPTS_DIR=$WORKSPACE/scripts/dcaegen2-sonhandler/sonhandler
TEST_ROBOT_DIR=$WORKSPACE/tests/dcaegen2-sonhandler/sonhandler
...
docker run -d --name configdb_oof_sim --network=sonhandler_sonhms-default -p "5000:5000"  configdb_oof_sim:latest;
sleep 60
