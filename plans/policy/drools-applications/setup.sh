...
docker pull nexus3.onap.org:10001/onap/policy-pdpd-cl:1.4-SNAPSHOT-latest
docker-compose -f ${WORKSPACE}/scripts/policy/docker-compose-drools-apps.yml run --rm start_dependencies
docker-compose -f ${WORKSPACE}/scripts/policy/docker-compose-drools-apps.yml --verbose up -d
sleep 1m
docker-compose logs
