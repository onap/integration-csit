...
bash ${SCRIPTS}/policy/policy-models-simulators.sh
...
${SCRIPTS}/policy/wait_for_port.sh localhost 6969

ROBOT_VARIABLES="-v POLICY_DROOLS_IP:${POLICY_DROOLS_IP} -v SCR2:${SCR2}"
