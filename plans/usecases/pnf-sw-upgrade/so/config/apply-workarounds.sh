...
apply_workaround()
{
 ...
 BEGIN;
  ...
  ('b2fd5627-55e4-4f4f-8064-9e6f443e9152','PNFSoftwareUpgrade.bpmn','PNFSoftwareUpgrade.bpmn','PNFSoftwareUpgrade.bpmn',1.0,'Pnf Workflow to upgrade software',null,'pnf','native');
