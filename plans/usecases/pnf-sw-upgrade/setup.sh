...
RES_KEY=$(uuidgen -r)
sed -i "s/pnfaddr/$LOCAL_IP/g" $REQUEST_DATA_PATH/preCheck.json
sed -i "s/pnfaddr/$LOCAL_IP/g" $REQUEST_DATA_PATH/downloadNeSw.json

sed -i "s/reskey/$RES_KEY/g" $REQUEST_DATA_PATH/preCheck.json
sed -i "s/reskey/$RES_KEY/g" $REQUEST_DATA_PATH/downloadNeSw.json
