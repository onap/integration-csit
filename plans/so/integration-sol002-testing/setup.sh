...
SCRIPT_ETSI_HOME="$SCRIPT_HOME/../integration-etsi-testing"
CONFIG_DIR=$SCRIPT_ETSI_HOME/config
...
MVN_VERSION="$MVN -v"
MVN_SETTINGS_XML="$SCRIPT_ETSI_HOME/settings.xml"
MVN_CLEAN_INSTALL="$MVN clean install"
SIMULATOR_MAVEN_PROJECT_POM="$SCRIPT_ETSI_HOME/so-simulators/pom.xml"
