...
public class ServiceOperationsCacheServiceProviderimpl extends AbstractCacheServiceProvider
    ...
    @Override
    public GenericResourceApiServicestatusServiceStatus putServiceOperationInformation(
        ...
        return getServiceStatus(getSvcAction(input.getSdncRequestHeader()), getAction(input.getRequestInformation()),
