...
public class OperationsController {
    ...
    public ResponseEntity<?> postServiceOperationInformation(
        ...
        final OutputRequest<GenericResourceApiServicestatusServiceStatus> outputRequest = new OutputRequest<>();
        outputRequest.setOutput(serviceStatus);
        if (serviceStatus.getResponseCode().equals(HttpStatus.OK.toString())) {
