...
public interface ServiceOperationsCacheServiceProvider {
    ...
    GenericResourceApiServicestatusServiceStatus putServiceOperationInformation(
            final GenericResourceApiServiceOperationInformation apiServiceOperationInformation);
    
    Optional<GenericResourceApiServiceModelInfrastructure> getGenericResourceApiServiceModelInfrastructure(final String serviceInstanceId);
