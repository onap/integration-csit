...
docker cp /home/root1/Documents/file.sql $(docker container ls | grep mariadb | awk '{ print $1 }'):/
docker exec $(docker container ls | grep mariadb | awk '{ print $1 }') sh -c 'mysql -u root -ppassword <  /file.sql'
