...
export DGBUILDER_DOCKER_IMAGE_VERSION=0.2.4
export ANSIBLE_DOCKER_IMAGE_VERSION=1.4-STAGING-latest
...
docker pull $NEXUS_DOCKER_REPO/${SOLUTION_NAME}/sdnc-ansible-server-image:$ANSIBLE_DOCKER_IMAGE_VERSION
docker tag $NEXUS_DOCKER_REPO/${SOLUTION_NAME}/sdnc-ansible-server-image:$ANSIBLE_DOCKER_IMAGE_VERSION onap/sdnc-ansible-server-image:latest
