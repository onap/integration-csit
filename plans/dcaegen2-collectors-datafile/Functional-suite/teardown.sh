...
echo "List of Consul config before cleaning"
chmod 777 -R $WORKSPACE/archives/dfc/integration/test/mocks/datafilecollector-testharness/simulator-group/consul/

ls -la $WORKSPACE/archives/dfc/integration/test/mocks/datafilecollector-testharness/simulator-group/consul/consul/
ls -la $WORKSPACE/archives/dfc/integration/test/mocks/datafilecollector-testharness/simulator-group/consul/
rm $WORKSPACE/archives/dfc/integration/test/mocks/datafilecollector-testharness/simulator-group/consul/consul/cbs_localhost_config.hcl
