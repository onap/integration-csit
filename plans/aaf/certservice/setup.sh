...
docker run -p 8080:8080 -d --mount type=bind,source=/w/workspace/aaf-master-verify-csit-certservice/plans/aaf/certservice/cmpServers.json,target=/etc/onap/aaf/certservice/cmpServers.json --name aafcert ${AAFCERT_IMAGE}
