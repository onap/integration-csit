...
CONFIGURATION_PATH="/w/workspace/aaf-master-verify-csit-certservice/plans/aaf/certservice/$CONFIGURATION_FILE"

SCRIPT=`realpath $0`
CURRENT_WORKDIR_PATH=`dirname $SCRIPT`

if test -f "$CURRENT_WORKDIR_PATH/$CONFIGURATION_FILE"; then
